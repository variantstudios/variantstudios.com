...
gulp.task('watch', function () {
    ...
    gulp.watch(['_config.yml', '_team/**', '_portfolio/**', 'assets/images/**', '_service/**', 'news/**', 'pages/**', 'index.html', '_layouts/**.html', '_includes/**.html', '_data/**', 'all-events.json'], ['jekyll-rebuild']);
});
